...
class _UpdateSheetState extends State<UpdateSheet> {
  ...
  void downloadAndInstallUpdate() async {
    final filename = "Animetn_${widget.version}.${Platform.isWindows ? "exe" : "apk"}";
    ...
    if (File(downloadPath).existsSync()) {
      ...
      final oldVersion = File(
          "${tempPath.path}/Animetn_${(await PackageInfo.fromPlatform()).version}.${Platform.isWindows ? "exe" : "apk"}");
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () async {
                      await launchUrl(
                        Uri.parse("https://github.com/frostnova721/Animetn/releases/latest"),
