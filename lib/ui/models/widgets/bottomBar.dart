...
class AnimetnBottomBar extends StatefulWidget {
  ...
  @override
  State<AnimetnBottomBar> createState() => _AnimetnBottomBarState();
}

class _AnimetnBottomBarState extends State<AnimetnBottomBar> {
  @override
  void initState() {
    super.initState();
...
class AnimetnBottomBarController {
  final int length;
