...
class AnimetnNavRail extends StatefulWidget {
  final List<AnimetnNavDestination> destinations;
  final AnimetnBottomBarController controller;
  final int initialIndex;
  final bool shouldExpand;
  final bool autoCollapse;
  const AnimetnNavRail({
    super.key,
  ...
  @override
  State<AnimetnNavRail> createState() => _AnimetnNavRailState();
}

class _AnimetnNavRailState extends State<AnimetnNavRail> {
  @override
  void initState() {
    super.initState();
