...
class BottomControls extends StatelessWidget {
                    ...
                    IconButton(
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (context) {
                            return sleepTimerDialog(context, playerProvider);
                          },
                        );
                      },
                      tooltip: "Sleep Timer",
                      icon: Icon(
                        Icons.snooze,
                        color: playerProvider.state.sleepTimerMinutes > 0 ? appTheme.accentColor : Colors.white,
                      ),
                    ),
                    IconButton(
                      onPressed: () {
  ...
  Widget sleepTimerDialog(BuildContext context, PlayerProvider pp) {
    final List<int> options = [0, 15, 30, 60, 120];
    return Container(
      height: MediaQuery.of(context).size.height / 2,
      child: AlertDialog(
        backgroundColor: appTheme.modalSheetBackgroundColor,
        content: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                "Sleep Timer",
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, fontFamily: "Rubik", color: Colors.white),
              ),
            ),
            Expanded(
              child: StatefulBuilder(
                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              children: [
                                Radio<int>(
                                  value: val,
                                  groupValue: pp.state.sleepTimerMinutes,
                                  onChanged: (v) {
                                    pp.setSleepTimer(v ?? 0);
                                    setState(() {});
                                  },
                                ),
                                Text(
                                  val == 0 ? "Off" : "$val Minutes",
