...
class AnimetnLoading extends StatefulWidget {
  final Color color;
  final double size;
  final Duration duration;

  const AnimetnLoading({
    Key? key,
  ...
  @override
  _AnimetnLoadingState createState() => _AnimetnLoadingState();
}

class _AnimetnLoadingState extends State<AnimetnLoading>
