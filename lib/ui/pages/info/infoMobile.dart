...
import 'package:animetn/ui/models/bottomSheets/batchDownloadSheet.dart';
import 'package:animetn/ui/models/bottomSheets/commentSection.dart';
...
import 'package:animetn/ui/models/bottomSheets/manualSearchSheet.dart';
import 'package:animetn/ui/models/bottomSheets/mediaListStatus.dart';
import 'package:animetn/ui/models/bottomSheets/serverSelectionSheet.dart';
...
import 'package:animetn/ui/models/widgets/loader.dart';
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: appTheme.accentColor.withAlpha(150), width: 1.5),
                          borderRadius: BorderRadius.circular(20)
                        ),
                        child: Text(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: appTheme.accentColor.withAlpha(80), width: 1.0),
                            borderRadius: BorderRadius.circular(10)
                          ),
                          child: Text(
              ...
              Row(
                ...
                children: [
                  IconButton(
                    ...
                    iconSize: 27,
                    icon: Icon(
                      provider.inWatchlist ? Icons.bookmark_rounded : Icons.bookmark_border_rounded,
                      color: Colors.white,
                    ),
                    style: IconButton.styleFrom(backgroundColor: Color.fromARGB(69, 0, 0, 0)),
                  ),
