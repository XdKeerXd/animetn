...
import 'package:animetn/core/database/anilist/queries.dart';
...
import 'package:animetn/ui/models/widgets/cards/animeCard.dart';
...
class _AnimeListsState extends State<AnimeLists> with TickerProviderStateMixin {
  ...
  final railController = AnimetnBottomBarController(length: 4);
                      ...
                      children: [
                        if (Platform.isWindows || Platform.isLinux)
                          AnimetnNavRail(
                              shouldExpand: true,
                              destinations: [
                                const AnimetnNavDestination(icon: Icons.movie, label: "Watching"),
                                const AnimetnNavDestination(icon: Icons.calendar_month, label: "Planned"),
                                const AnimetnNavDestination(icon: Icons.highlight_off_outlined, label: "Dropped"),
                                const AnimetnNavDestination(icon: Icons.task_alt_rounded, label: "Completed")
                              ],
