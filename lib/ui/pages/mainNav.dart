...
import 'package:animetn/core/app/update.dart';
import 'package:animetn/core/commons/utils.dart';
import 'package:animetn/core/data/downloadHistory.dart';
...
import 'package:animetn/ui/pages/discover.dart';
import 'package:animetn/ui/pages/home.dart';
import 'package:animetn/ui/pages/search.dart';
import 'package:animetn/ui/pages/watchlistPage.dart';
...
class MainNavigatorState extends State<MainNavigator> with TickerProviderStateMixin {
  ...
  AnimetnBottomBarController _barController = AnimetnBottomBarController(length: 4);
        ...
        body: MediaQuery.of(context).orientation == Orientation.landscape || Platform.isWindows || Platform.isLinux
            ? Row(
                children: [
                  // AnimetnNavRail(
                  //   destinations: [
                  //     AnimetnNavDestination(icon: Icons.home, label: "Home"),
                  //     AnimetnNavDestination(icon: Icons.auto_awesome, label: "Discover"),
                  //     AnimetnNavDestination(icon: Icons.search, label: "Search"),
                  //   ],
      ...
      children: [
        ...
        AnimetnBottomBar(
          ...
          items: [
            ...
            BottomBarItem(title: 'Watchlist', icon: Icon(Icons.bookmark)),
          ],
        )
      ],
    );
