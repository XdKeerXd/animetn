...
import 'package:animetn/ui/models/widgets/infoPageWidgets/scrollingList.dart';
import 'package:flutter/material.dart';

import 'package:animetn/core/app/runtimeDatas.dart';
import 'package:animetn/ui/models/widgets/header.dart';
import 'package:animetn/ui/pages/genres.dart';
import 'package:animetn/ui/pages/info.dart';
import 'package:animetn/ui/pages/news.dart';
    ...
    return Container(
      ...
      child: list.length > 0
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) => SkeletonAnimeCard(isMobile: true),
            ),
    );
  }
