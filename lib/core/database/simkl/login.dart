...
import 'package:animetn/core/app/env.dart';
import 'package:animetn/core/commons/enums.dart';
import 'package:animetn/core/data/secureStorage.dart';
import 'package:animetn/core/database/anilist/types.dart';
import 'package:animetn/core/database/database.dart';
import 'package:animetn/core/database/simkl/mutations.dart';
import 'package:animetn/core/database/simkl/types.dart';
...
class SimklLogin extends DatabaseLogin {
  static const callbackScheme = "auth.Animetn://";

  @override
  Future<bool> initiateLogin() async {
    final clientId = AnimetnEnvironment.simklClientId;
    final clientSecret = AnimetnEnvironment.simklClientSecret;
  ...
  static Future<PCKECodeResult> getPkceCode() async {
    final url = "https://api.simkl.com/oauth/pin?client_id=${AnimetnEnvironment.simklClientId}";
  ...
  static Future<bool> verifyPkceCode(PCKECodeResult codeRes) async {
    final url = "https://api.simkl.com/oauth/pin/${codeRes.userCode}?client_id=${AnimetnEnvironment.simklClientId}";
